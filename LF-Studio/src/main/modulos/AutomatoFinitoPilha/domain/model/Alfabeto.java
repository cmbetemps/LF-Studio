...
public class Alfabeto {
    ...
    public boolean validar(String palavra) {
        ...
        if(!alfabetoFita.containsAll(auxiliar)){
            System.out.println("Erro - A palavra possui símbolos que não pertencem ao alfabeto de entrada.");
            flagValido = false;
        } else {
            System.out.println("Ok - Todos os símbolos da palavra pertencem ao alfabeto de entrada.");
        }
